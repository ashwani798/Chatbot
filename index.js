var data= {
    ...
    news: {
        ...
        options:["top 5 news"],
        url : {
            more:"https://www.youtube.com/live/hOM1Wr8aNp8?si=yq2MohQrdL2iqN81",
            link:["https://www.youtube.com/live/Ezio0SoGMhA?si=TI66k1BvEYTB8Wtg","https://youtu.be/spM-6jke2WQ?si=j7oP3TgCaiCqSvjL","https://youtu.be/bbgTMfPfW6g?si=wq6lbYi6PVQNLO8s","https://youtu.be/O0Fj5SmD8lw?si=RCrckHyMFdsdxevA"]
        }
    },
    shopping: {
    ...
    electronics: {
        ...
        url : {
            more:"https://youtu.be/4F0HOGj2cJ4?si=1m5MaFEetv6HzVj9",
            link:["#","#","#","#","#"]
        }
    },
    beauty: {
        ...
        url : {
            more:"https://youtu.be/YeeEMVtiNbo?si=o0utgVapnWrprPl8",
            link:["#","#","#","#"]
        }
    },
    mobiles: {
        ...
        url : {
            more:"https://youtu.be/S0p2DrOX0OU?si=iyhRBxIRvQtEVkKK",
            link:["#","#","#","#"]
        }
    },
    men: {
        ...
        url : {
            more:"https://youtu.be/m7Z5urOOdso?si=11j3BbEumfUa2YdA",
            link:["#","#","#","#","#"]
        }
    },
    women: {
        ...
        url : {
            more:"https://youtu.be/r-cvZL056yg?si=-mYZCewIPvvetVix",
            link:["#","#","#","#"]
        }
    },
    music: {
        ...
        url : {
            more:"https://youtu.be/r-cvZL056yg?si=-mYZCewIPvvetVix",
            link:["https://youtu.be/6k8Aja80GQM?si=ctxOswHAA3DLSMHC","https://youtu.be/jADTdg-o8i0?si=vllGR5xB6u0BXgoE","https://youtu.be/Tq3LW8ZQ91w?si=Fi_Btt2ynuW8TcYw","https://youtu.be/WfDFWLZgQwE?si=lM53a0mv2eoVlkhb"]
        }
    },
    hollywood: {
        ...
        url: {
            more:"https://youtu.be/MKTCnjaFxqo?si=akHiHUT5-2r5DIEU",
            link:["#","#","#","#","#"]
        }
    },
    bollywood: {
        ...
        options: ["Comedy","Horror","Sci-Fi","Romance","Action"],
        url: {
            more:"https://youtu.be/WfDFWLZgQwE?si=lM53a0mv2eoVlkhb",
            link:["#","#","#","#","#"]
        }
    },
    web: {
        ...
        options: ["Comedy","Horror","Sci-Fi","Romance","Action"],
        url: {
            more:"https://youtu.be/zloKjQXmwhE?si=3WgCdoPObR3ZtXKI",
            link:["#","#","#","#","#"]
        }
    },
    others: {
